...
public class SortingExercisesTest
{
	 ...
	 * 
	 * 
	 * @Test public void recursiveBubbleSortTest1() { Integer[] arr = {0, 1, 2, 2,
	 * 1, 0, 1, 0}; Integer[] expected = {0, 0, 0, 1, 1, 1, 2, 2};
	 ...
	 * 
	 * 
	 * @Test public void recursiveBubbleSortTest2() { Character[] arr = {'z', 'a',
	 * 'd', 'b', 'c'}; Character[] expected = {'a', 'b', 'c', 'd', 'z'};
	 * 
	 * assertArrayEquals("recursiveBubbleSort failed", expected,
	 * SortingExercises.recursiveBubbleSort(arr)); }
	 * 
	 * 
	 */
